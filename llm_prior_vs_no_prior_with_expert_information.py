...
PRIORS_DIR = "./priors/elicitation/with_expert_information"
...
RESULTS_DIR = "./results/elicitation/with_expert_information"
...
if GET_FROM_API:
    ...
    for dataset_name in DATASET_PRIORS_TO_GET:
        ...
        system_roles = load_prompts(
            os.path.join(
                PROMPTS_DIR, f"system_roles_{dataset_name}_with_expert_information.txt"
            )
        )
        ...
        user_roles = load_prompts(
            os.path.join(
                PROMPTS_DIR, f"user_roles_{dataset_name}_with_expert_information.txt"
            )
        )
